...
function Login({ onLogin }) {
  const [email, setEmail] = useState('admin@mesanexo.com.br')
...
function Dashboard({ store, goTo }) {
  ...
  return <>
    ...
    <div className="alert-strip"><span><Sparkles size={17}/></span><div><strong>Boa tarde, Lucas.</strong> O movimento está 12,5% acima da última quinta-feira.</div><button onClick={() => goTo('reports')}>Ver análise <ChevronRight size={15}/></button></div>
